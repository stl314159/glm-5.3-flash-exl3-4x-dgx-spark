...
TUNABLES="VLLM_PREFIX_CACHE_RETENTION_INTERVAL_SWA SPEC_METHOD MAX_MODEL_LEN GPU_MEM_UTIL MAX_NUM_SEQS MAX_NUM_BATCHED_TOKENS KV_CACHE_DTYPE DFLASH_TOKENS NCCL_DEBUG NCCL_PROTO NCCL_ALGO NCCL_IB_TIMEOUT NCCL_IB_RETRY_CNT NCCL_BUFFSIZE NCCL_MIN_NCHANNELS NCCL_MAX_NCHANNELS NCCL_IB_QPS_PER_CONNECTION NCCL_IB_SPLIT_DATA_ON_QPS NCCL_NET_GDR_LEVEL NCCL_IB_HCA NCCL_IB_TC NCCL_IB_FIFO_TC NCCL_IB_ADDR_RANGE RDMA_GID_MODE EXTRA_ARGS VLLM_USE_BREAKABLE_CUDAGRAPH MIXED_PREFILL_CHUNK EXL3_FAT_KERNEL SWAPPINESS VLLM_SM120_SPARSE_MLA_SLICE_TOKENS"
